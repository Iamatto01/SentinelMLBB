...
import { Swords, Trophy, Target, Activity, Plus, Search, ChevronDown } from "lucide-react";
    ...
    <div className="w-full h-full flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400">
            {totalGames} games recorded · {winRate}% win rate
          </p>
        </div>
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search by hero, result..."
            value={search}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-6 rounded-2xl">
          ...
          <div className="h-[250px]">
            {heroWinData.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={heroWinData}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-neutral-400">Loading games...</td>
                </tr>
              ) : filteredGames.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-neutral-400">No games found</td>
                </tr>
              ) : (
